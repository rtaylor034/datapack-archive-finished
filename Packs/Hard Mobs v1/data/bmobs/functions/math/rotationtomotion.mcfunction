...
execute as @e[tag=mathrttp,limit=1,sort=nearest] at @s store result score @e[tag=mathrtt,limit=1,sort=nearest] posx2 run data get entity @s Pos[0] 1000000
execute as @e[tag=mathrttp,limit=1,sort=nearest] at @s store result score @e[tag=mathrtt,limit=1,sort=nearest] posy2 run data get entity @s Pos[1] 1000000
execute as @e[tag=mathrttp,limit=1,sort=nearest] at @s store result score @e[tag=mathrtt,limit=1,sort=nearest] posz2 run data get entity @s Pos[2] 1000000
